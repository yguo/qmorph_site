const I18N = {
  zh: {
    ...
    nav_connect:'接入', nav_serve:'服务', nav_cal:'日程', nav_report:'报告', nav_demo:'体验 Demo',
  ...
  en: {
    ...
    nav_connect:'Connect', nav_serve:'Serve', nav_cal:'Calendar', nav_report:'Reports', nav_demo:'Try Demo',
    hero_title:'Your AI Front Desk,<br><span>Always On.</span>',
  ...
  ja: {
    ...
    nav_connect:'接続', nav_serve:'通話', nav_cal:'予約', nav_report:'レポート', nav_demo:'デモ体験',
    hero_title:'Your AI Front Desk,<br><span>Always On.</span>',
